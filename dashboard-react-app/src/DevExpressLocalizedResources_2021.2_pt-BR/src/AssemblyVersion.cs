...
#elif WINUI
namespace DevExpress.WinUI.Core.Internal {
    public static class AssemblyInfo {
#else
namespace DevExpress.Internal {
    ...
    public const int VersionId = 212;
    public const int VersionIdMinor = 21201;
    public const string VersionShort = "21.2";
#if WINUI
    ...
    public const string MarketingVersion = "v2021 vol 2";
    public const string VirtDirSuffix = "_v21_2";
